...
// BEAR Breakout Alert - Flat EMA + Consolidation + Volume Filter (15 Min Timeframe)
// Signals (ret = 1) when:
...
// 4) Current low breaks below min low of prior 5 bars by at least 0.4%
...
begin
    ...
    begin
        ...
        // ===== Check 1b: 20 EMA < 56 EMA (bearish trend) =====
        ...
        // ===== Check 3b: Breakout must be significant (at least 0.4% beyond prior low) =====
