...
// Breakout Alert - Flat EMA + Consolidation + Volume Filter (5 Min Timeframe)
// Signals (ret = 1) when:
...
// 4) Current high breaks above max high of prior 5 bars by at least 0.3%
...
begin
    ...
    begin
        ...
        // ===== Check 3b: Breakout must be significant (at least 0.3% beyond prior high) =====
