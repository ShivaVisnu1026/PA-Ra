// Daily Bullish Pin Bar + Daily EMA Up (Screener Script)
// Description:
//   - Primary Frequency: Daily only
//   - Daily EMA calculated on daily closes
//   - Screens for bullish pin bar reversal patterns with upward EMA slope
...
// ===== Daily EMA Slope Up =====
var: d_ema(0), d_ema_prev(0), ema_diff(0), isDailyUp(false);
